...
module attributes {ttcore.system_desc = #system_desc} {
  ...
  func.func @test_view_to_stream_remote_load_update() -> memref<1x64x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096, 1, (d0, d1, d2, d3) -> (d1 floordiv 8, d1 mod 8, d2, d3)>, #l1> {
    ...
    ^unified0(%cb0: !d2m.cb<memref<1x2x!ttcore.tile<32x32, f32>, #l1>>, %cb1: !d2m.cb<memref<2x1x!ttcore.tile<32x32, f32>, #l1>>, %cb2: !d2m.cb<memref<1x1x!ttcore.tile<32x32, f32>, #l1>>):
      ...
      %0 = d2m.remote_load %view_5[%iter0, %iter2] mcast[%c1] : memref<1x64x1x2x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #l1> -> memref<1x2x!ttcore.tile<32x32, f32>, #l1>
      ...
      %2 = d2m.remote_store %alloc_4[%iter0_12, %iter1_13] %buffer : memref<1x64x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096, 1, (d0, d1, d2, d3) -> (d1 floordiv 8, d1 mod 8, d2, d3)>, #l1>, memref<1x1x!ttcore.tile<32x32, f32>, #l1> -> memref<1x64x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096, 1, (d0, d1, d2, d3) -> (d1 floordiv 8, d1 mod 8, d2, d3)>, #l1>
    }
