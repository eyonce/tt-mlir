...
// Update all IterIndexOp dimensions to reflect the new iteration order after
// interchange. For interchange [2, 0, 1]:
...
static void updateIterIndexOpsForInterchange(GenericOp generic,
                                             Builder &builder,
...
public:
  ...
  void runOnOperation() final {
    ...
    moduleOp.walk([&](GenericOp generic) {
      ...
      updateIterIndexOpsForInterchange(generic, builder, *interchange);
    });
  }
